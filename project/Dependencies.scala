...
object Dependencies {
  ...
  object Blindsight {
    ...
    val blindsightLogstash = "com.tersesystems.blindsight" %% "blindsight-logstash" % blindsightVersion
    // https://tersesystems.github.io/blindsight/usage/inspections.html
    val blindsightInspection = "com.tersesystems.blindsight" %% "blindsight-inspection" % blindsightVersion
    // https://tersesystems.github.io/blindsight/usage/scripting.html
    val blindsightScripting = "com.tersesystems.blindsight" %% "blindsight-scripting" % blindsightVersion
    ...
    val blindsightRingbuffer = "com.tersesystems.blindsight" %% "blindsight-ringbuffer" % blindsightVersion
    val blindsightLogbackStructuredConfig = "com.tersesystems.logback" % "logback-structured-config" % terseLogbackVersion
  }
  ...
  val logbackUniqueId = "com.tersesystems.logback" % "logback-uniqueid-appender" % terseLogbackVersion
